<?php
//$activeMain = json_decode(file_get_contents('../../admin/inc/configMaintenance.json'), true);
define('BASEPATH', true);
//if ( $activeMain['Weather'] == 'in_active' ) {
//	define('BASEPATH', true);
//}elseif ( $activeMain['Weather'] == 'active' ) {
//  if ( $_SERVER['REMOTE_ADDR'] == '192.168.0.1' ) {
//		define('BASEPATH', true);
//    echo '<center><h3 style="color: red;">'.$activeMain['Post'].' - maintenance</h3></center>';
//  }else {
